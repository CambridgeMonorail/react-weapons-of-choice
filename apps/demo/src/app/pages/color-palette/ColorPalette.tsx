    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <Tabs defaultValue="pairs" className="w-full">
        ...
        <TabsContent value="pairs">
          ...
          <h2 className="text-2xl font-semibold mb-4">What is WCAG Contrast?</h2>
          <div className="mb-4">
          ...
          <h2 className="text-2xl font-semibold mb-4">Color Pair Definitions</h2>
          <div className="mb-4">
          ...
          <h2 className="text-2xl font-semibold mb-4">Why Contrast is Important</h2>
          <div className="mb-4">
            Low contrast ratios can make content difficult to read,
            particularly for users with vision impairments or in low-light
            conditions. By understanding the contrast levels of your theme
            colors, you can:
            <ul className="list-disc list-inside">
